...
<div class="modal fade" id="defaultModalPrimary" tabindex="-1" aria-hidden="true" style="display: none;">
			<div class="modal-dialog modal-lg" role="document">
				...
				@csrf
					...
					<div class="col-md-4">
						<label for="validationDefault05" class="form-label">Doc Attachement</label>
						<input type="file" class="form-control" id="validationDefault05" name="docimage" required>
					</div>
					<div class="col-md-6">
						<label for="validationDefault05" class="form-label">Issue Date</label>
						<input type="date" class="form-control" id="validationDefault05" name="busname" onkeyup="this.value = this.value.toUpperCase();" placeholder="Enter Business Name" >
					</div>
					<div class="col-md-6">
						<label for="validationDefault05" class="form-label">Expery Date</label>
						<input type="date" class="form-control" id="validationDefault05" name="busaddress" onkeyup="this.value = this.value.toUpperCase();" placeholder="Enter Business Address" required>
					</div>
					<div class="col-md-4">
					...
					<div class="col-md-4">
						<label for="validationDefault05" class="form-label">Tax ID</label>
						<input type="text" class="form-control" id="validationDefault05" name="taxid" onkeyup="this.value = this.value.toUpperCase();" placeholder="Enter Valid BVN No" required>
					</div>
					...
					<div class="col-md-6">
						<label for="validationDefault05" class="form-label">Business Name</label>
						<input type="text" class="form-control" id="validationDefault05" name="busname" onkeyup="this.value = this.value.toUpperCase();" placeholder="Enter Business Name" >
					</div>
					<div class="col-md-6">
						<label for="validationDefault05" class="form-label">Business Address</label>
						<input type="text" class="form-control" id="validationDefault05" name="busaddress" onkeyup="this.value = this.value.toUpperCase();" placeholder="Enter Business Address" required>
					</div>
					<div class="col-md-6">
