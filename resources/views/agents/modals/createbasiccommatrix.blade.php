...
<div class="modal fade" id="basicCommissionModal" tabindex="-1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div id="basicCommissionContainer">
            <div class="modal-body m-3">
                <form class="row g-3" method="POST" action="{{ route('basiccommissionmatrix.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="switchToAdvanced">Switch to Advanced</button>
...
<!-- END Create Basic Commission Matrix Modal -->
            ...
            <div id="commissionMatrixContainer" style="display: none;">
            <div class="modal-body m-3">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="switchToBasic">Switch to Basic</button>
...
<script>
    $(document).ready(function() {
        // Function to switch between Basic and Commission Matrix containers
        $('#switchToAdvanced').on('click', function() {
            $('#basicCommissionContainer').toggle(); // Toggle Basic Commission container
            $('#commissionMatrixContainer').toggle(); // Toggle Commission Matrix container
        });
        // Function to switch back to Basic
        $('#switchToBasic').on('click', function() {
            $('#basicCommissionContainer').toggle(); // Toggle Basic Commission container
            $('#commissionMatrixContainer').toggle(); // Toggle Commission Matrix container
        });
    });
