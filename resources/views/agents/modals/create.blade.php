            ...
            <div class="modal-body m-3">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <select onchange="toggleLGA(this);" name="state" id="state" class="form-control" name="state_id">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="lga" id="lga" class="form-control select-lga" name="lga_id" required></select>
