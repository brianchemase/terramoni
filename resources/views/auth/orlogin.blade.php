...
<head>
	...
	<link rel="shortcut icon" href="dash/img/icons/icon-48x48.png" />

	<link rel="canonical" href="pages-sign-in.html" />

	<title>Tera Moni Login</title>
							...
							<div class="card-body">
								<div class="m-sm-4">
									<div class="text-center">
										<img src="dash/img/avatars/avatar.jpg" alt="Charles Hall" class="img-fluid rounded-circle" width="132" height="132" />
									</div>
