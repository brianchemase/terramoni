        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo">
              <img src="landing/assets/images/tsp-logo.png" width="16" height="75" alt="Tera">
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
  ...
  <div id="pricing" class="pricing-tables">
    <div class="container">
      <div class="row">
        <div class="col-lg-8 offset-lg-2">
          <div class="section-heading">
            <h4>Register as an <em>Agent</em></h4>
            <img src="landing/assets/images/heading-line-dec.png" alt="">
            <p>Select the appropriate link for your account registration</p>
          </div>
        </div>
