...
<main class="content">
				...
				@endif
								<div class="card-body">
									...
									<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#createPermission">
									<i class="fa fa-users" aria-hidden="true"></i> Create New Permission
									</button>
									@include('agents.modals.createpermission')
